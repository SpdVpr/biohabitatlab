...
export const blueprints: Blueprint[] = [

    {
        ...
        products: [
            ...
            {
                name: "Philips Hue Starter Kit (3 bulbs + Bridge)",
                role: "Ambient Room Automation",
                spec: "2000K–6500K via app, ZigBee protocol",
                link: "#",
                price: "$130",
    ...
    },
    {
        ...
        products: [
            {
                name: "Roxul Safe'n'Sound (6-pack batts)",
            ...
            {
                name: "ATS Acoustic Panel (24x48 inches)",
                role: "Ready-Made Wall Treatment",
                spec: "Fabric-wrapped, NRC 0.85, ASTM E84 Class A Fire Rated",
                link: "#",
                price: "$70 each",
                whyThisOne: "If you don't want to DIY, these are professional-grade panels with clean aesthetics. The fabric wrap means no exposed foam—just clean, architectural panels that blend with decor. Fire-rated means safe for home use.",
            },
            {
                name: "Acoustic Door Seal Kit",
                role: "Sound Isolation",
                spec: "Adhesive weatherstripping + door sweep",
                link: "#",
                price: "$35",
                whyThisOne: "The biggest weak point in any room is the door. Sound travels through the gaps around the frame. This kit seals all four sides with dense weatherstripping that blocks both sound and drafts. Easy 30-minute install.",
            },
        ],
        steps: [
    ...
    },
    {
        ...
        products: [
            {
                name: "Sleepout Portable Blackout Curtain",
                role: "Window Light Elimination",
                spec: "100% Light Block, Suction Cup Mount, Travel-Friendly",
                link: "#",
                price: "$50",
                whyThisOne: "Unlike regular blackout curtains that still leak light around edges, Sleepout uses suction cups to seal completely against the window frame. Zero light gaps. Removable so it works in rentals. Take it when you travel for consistent sleep quality in hotel rooms.",
            },
            {
            ...
            {
                name: "Amber LED Motion Night Lights (2-pack)",
                role: "Safe Nighttime Navigation",
                spec: "590nm Amber (Zero Blue), Motion Activated, Plug-in",
                link: "#",
                price: "$20",
                whyThisOne: "For bathroom trips at night, you need some light—but not white or blue light that kills melatonin. These emit pure amber light (590nm wavelength) that allows you to see without disrupting sleep hormones. Motion-activated so they only turn on when needed.",
            },
        ],
        steps: [
